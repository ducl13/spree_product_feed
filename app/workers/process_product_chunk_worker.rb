class ProcessProductChunkWorker
  ...
  def perform(url_options, current_store_id, current_currency, product_ids, file_name, channel, doc,  batch_size, batch_index, last_xml_product_id)
     product_ids.each_with_index do |product_id, product_index|
      ...
      SingleProductFeedWorker.perform_async(url_options, current_store_id, current_currency, product_id, file_name, channel,doc,  batch_size, batch_index, product_ids.last, last_xml_product_id, product_index)
    end
